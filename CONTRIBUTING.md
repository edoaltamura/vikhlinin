Contributing to Vikhlinin-fit
==========================

Contributions for Vikhlinin-fit should come through our GitHub repository,
available at [https://github.com/edoaltamura/vikhlinin](https://github.com/edoaltamura/vikhlinin).
...
+ We pledge to help the entire community follow the code of conduct, and to
  ...
  contacting edoardo.altamura@manchester.ac.uk with the subject line _SWIFTsimIO Code
  of Conduct_ (all emails sent in this fashion will be treated with the
...
Any related activity or project organized by members of the `Vikhlinin-fit`
